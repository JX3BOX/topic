<template>
    <div class="m-topic-nav" :class="`${new_topic}-box`">
        ...
        <img class="m-bg p-animations" :class="animation ? 'fadeInHalf' : ''" :src="boxBG" :alt="new_topic" srcset="" />
        <div class="m-tabs">
            <img class="m-people p-animations" :class="[animation ? 'fadeInRight' : '', new_topic]" :src="peopleImg" alt="人物" srcset="" />
            <div class="u-tab">
    ...
    export default {
        ...
        computed: {
            ...
            topic() {
                ...
                let all_server = [...this.std_topic, ...this.origin_topic].sort((a, b) => b.id - a.id).map((item) => item.name);
                return [
